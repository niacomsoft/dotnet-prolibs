...
namespace Niacomsoft.ProductiveLibrary.Patterns
{
  ...
  ///   <para> 引用类型。 </para>
  /// </typeparam>
  /// <seealso cref="IKnownTypeFactory{T1, T2, T3, T4, T5, T6, T7, TResult}" />
  public interface IUnknownTypeFactory<in T1, in T2, in T3, in T4, in T5, in T6, in T7, out TResult> : IKnownTypeFactory<T1, T2, T3, T4, T5, T6, T7, TResult> where TResult : class
  {
    #region Methods
    ...
    TResult CreateInstance(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, params object[] args);
