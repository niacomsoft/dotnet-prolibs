...
namespace Niacomsoft.ProductiveLibrary.Utilities
{
  public static partial class AttributeUtilities
  {
    ...
    /// <param name="assm"> <see cref="MemberInfo" /> 类型的对象实例。 </param>
    ...
    ///   当调用 <see cref="Attribute.GetCustomAttribute(MemberInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    public static T GetCustomAttribute<T>(MemberInfo assm, bool inherit = true) where T : Attribute
    {
    ...
    ///   当调用 <see cref="Attribute.GetCustomAttribute(MemberInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    public static Attribute GetCustomAttribute(MemberInfo assm, Type attrType, bool inherit = true)
    {
    ...
    /// <exception cref="NotSupportedException">
    ///   当调用 <see cref="Attribute.GetCustomAttributes(MemberInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    /// <exception cref="AmbiguousMatchException">
    ///   当调用 <see cref="Attribute.GetCustomAttributes(MemberInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    ...
    public static IEnumerable<T> GetCustomAttributes<T>(MemberInfo assm, bool inherit = true) where T : Attribute
    {
    ...
    ///   当调用 <see cref="Attribute.GetCustomAttributes(MemberInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    public static Attribute[] GetCustomAttributes(MemberInfo assm, Type attrType, bool inherit = true)
    {
      NotAttributeType(attrType);
    ...
    ///   当调用 <see cref="Attribute.GetCustomAttribute(MemberInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    public static bool TryGetCustomAttribute<T>(MemberInfo assm, out T attr, bool inherit = true) where T : Attribute
    {
    ...
    ///   当调用 <see cref="Attribute.GetCustomAttribute(MemberInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    public static bool TryGetCustomAttribute(MemberInfo assm, Type attrType, out Attribute attr, bool inherit = true)
    {
    ...
    ///   当调用 <see cref="Attribute.GetCustomAttributes(MemberInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    public static bool TryGetCustomAttributes<T>(MemberInfo assm, out IEnumerable<T> attrs, bool inherit = true) where T : Attribute
    {
    ...
    ///   当调用 <see cref="Attribute.GetCustomAttributes(MemberInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    public static bool TryGetCustomAttributes(MemberInfo assm, Type attrType, out Attribute[] attrs, bool inherit = true)
    {
