...
namespace Niacomsoft.ProductiveLibrary.Utilities
{
  public static partial class Guard
  {
    ...
    /// <param name="method">
    ///   <see cref="Action{T1, T2, T3, T4, T5, T6, T7, T8, T9}" /> 类型的方法委托。
    /// </param>
    ...
    /// <typeparam name="T8"> 参数类型。 </typeparam>
    /// <param name="method">
    ///   <see cref="Action{T1, T2, T3, T4, T5, T6, T7, T8}" /> 类型的方法委托。
    /// </param>
    /// <param name="arg1"> <typeparamref name="T1" /> 类型的参数值。 </param>
    /// <param name="arg2"> <typeparamref name="T2" /> 类型的参数值。 </param>
    /// <param name="arg3"> <typeparamref name="T3" /> 类型的参数值。 </param>
    ...
    /// <seealso cref="Action{T1}" />
    /// <seealso cref="Result" />
    public static Result Execute(Action method, params object[] args)
    {
      try
      {
        if (AssertUtilities.IsNull(method))
    ...
    /// <returns> <see cref="Result{TResult}" /> 类型的对象实例。 </returns>
    /// <seealso cref="Result" />
    public static Result<TResult> Execute<TResult>(Func<TResult> method, params object[] args)
    {
      try
      {
        if (AssertUtilities.IsNull(method))
        ...
        return Result<TResult>.Complete(method(args));
      }
      catch (System.Exception error)
      {
        return Result<TResult>.WhenCatched(error);
    ...
    /// <returns> <see cref="Result" /> 类型的对象实例。 </returns>
    /// <seealso cref="Result" />
    public static Result Execute(System.Action method)
    {
      try
      {
        if (AssertUtilities.IsNull(method))
    ...
    /// <returns> <see cref="Result{TResult}" /> 类型的对象实例。 </returns>
    /// <seealso cref="Result" />
    public static Result<TResult> Execute<TResult>(System.Func<TResult> method)
    {
      try
      {
        if (AssertUtilities.IsNull(method))
        ...
        return Result<TResult>.Complete(method());
      }
      catch (System.Exception error)
      {
        return Result<TResult>.WhenCatched(error);
