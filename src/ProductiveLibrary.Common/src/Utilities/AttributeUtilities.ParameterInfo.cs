...
namespace Niacomsoft.ProductiveLibrary.Utilities
{
  public static partial class AttributeUtilities
  {
    ...
    /// <param name="assm"> <see cref="ParameterInfo" /> 类型的对象实例。 </param>
    /// <param name="inherit"> 是否检索继承链。 </param>
    /// <returns> <typeparamref name="T" /> 类型的对象实例。 </returns>
    /// <seealso cref="ParameterInfo" />
    /// <exception cref="NotSupportedException">
    ///   当调用 <see cref="Attribute.GetCustomAttribute(ParameterInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    ...
    ///   当调用 <see cref="Attribute.GetCustomAttribute(ParameterInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    public static T GetCustomAttribute<T>(ParameterInfo assm, bool inherit = true) where T : Attribute
    {
    ...
    ///   当调用 <see cref="Attribute.GetCustomAttribute(ParameterInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    public static Attribute GetCustomAttribute(ParameterInfo assm, Type attrType, bool inherit = true)
    {
    ...
    /// <exception cref="NotSupportedException">
    ///   当调用 <see cref="Attribute.GetCustomAttributes(ParameterInfo, Type, bool)" />
    ///   方法时，可能引发此类型的异常。
    /// </exception>
    /// <exception cref="AmbiguousMatchException">
    ///   当调用 <see cref="Attribute.GetCustomAttributes(ParameterInfo, Type, bool)" />
    ...
    public static IEnumerable<T> GetCustomAttributes<T>(ParameterInfo assm, bool inherit = true) where T : Attribute
    {
    ...
    ///   方法时，可能引发此类型的异常。
    /// </exception>
    public static Attribute[] GetCustomAttributes(ParameterInfo assm, Type attrType, bool inherit = true)
    {
      NotAttributeType(attrType);
    ...
    ///   当调用 <see cref="Attribute.GetCustomAttribute(ParameterInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    public static bool TryGetCustomAttribute<T>(ParameterInfo assm, out T attr, bool inherit = true) where T : Attribute
    {
    ...
    ///   当调用 <see cref="Attribute.GetCustomAttribute(ParameterInfo, Type, bool)" /> 方法时，可能引发此类型的异常。
    /// </exception>
    public static bool TryGetCustomAttribute(ParameterInfo assm, Type attrType, out Attribute attr, bool inherit = true)
    {
    ...
    ///   方法时，可能引发此类型的异常。
    /// </exception>
    public static bool TryGetCustomAttributes<T>(ParameterInfo assm, out IEnumerable<T> attrs, bool inherit = true) where T : Attribute
    {
    ...
    ///   方法时，可能引发此类型的异常。
    /// </exception>
    public static bool TryGetCustomAttributes(ParameterInfo assm, Type attrType, out Attribute[] attrs, bool inherit = true)
    {
